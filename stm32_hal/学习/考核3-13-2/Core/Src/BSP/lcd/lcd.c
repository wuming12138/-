...
void LCD_ShowChar(u8 Line, u8 Column, u8 ascii)
{
	LCD_SetBackColor(Blue);
	LCD_DisplayChar(Line, 320-16*(Column), ascii);
}

void LCD_ShowNum(u8 Line, u8 Column, uint8_t Num, vu16 Color)
{
	LCD_SetBackColor(Color);
	LCD_DisplayChar(Line, 320-16*(Column), Num/10+0x30);
	LCD_DisplayChar(Line, 320-16*(Column+1), Num%10+0x30);
