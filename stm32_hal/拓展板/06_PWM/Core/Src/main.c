...
//	sprintf(str, "x:%.3fg  y:%.3fg", xx * 18.0 / 1000, yy * 18.0 / 1000);
//	LCD_DisplayStringLine(Line2, (unsigned char *)str);
//	sprintf(str, "z:%.3fg", zz * 18.0 / 1000);
//	LCD_DisplayStringLine(Line3, (unsigned char *)str);

//	sprintf(str, "PR5:%04d", Get_ADC2_Channel(ADC_RP5));
//	LCD_DisplayStringLine(Line0, (unsigned char *)str);
//	
//	sprintf(str, "PR6:%04d", Get_ADC2_Channel(ADC_RP6));
//	LCD_DisplayStringLine(Line2, (unsigned char *)str);
//	
//	sprintf(str, "R37:%04d", Get_ADC2_Channel(ADC_R37));
